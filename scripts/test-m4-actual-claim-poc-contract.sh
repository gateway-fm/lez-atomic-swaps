...
jq -e '
  ...
  and .implemented_execute_through == "tag15_finality"
...
readonly post_tag13_fail='fail "extraction phase is not implemented; Tag15 finality completed; do not retry this run"'
