...
jq -e '
  ...
  and .implemented_execute_through == "tag15_signature"
...
readonly post_tag13_fail='fail "tag15 publication is not implemented; Maker final signature prepared; do not retry this run"'
