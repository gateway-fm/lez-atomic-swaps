...
jq -e '
  ...
  and .implemented_execute_through == "tag14_publication"
...
readonly post_tag13_fail='fail "finality phase is not implemented; Tag14 publication completed; do not retry this run"'
