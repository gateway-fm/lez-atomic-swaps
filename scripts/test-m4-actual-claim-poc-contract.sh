...
jq -e '
  ...
  and .implemented_execute_through == "tag14_finality"
...
readonly post_tag13_fail='fail "tag15 phase is not implemented; Tag14 finality completed; do not retry this run"'
