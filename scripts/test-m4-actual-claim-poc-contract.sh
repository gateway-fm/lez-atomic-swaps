...
jq -e '
  ...
  and .implemented_execute_through == "tag15_publication"
...
readonly post_tag13_fail='fail "tag15 finality is not implemented; Tag15 admission completed; do not retry this run"'
