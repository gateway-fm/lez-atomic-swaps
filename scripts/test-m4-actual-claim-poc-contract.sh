...
jq -e '
  ...
  and .implemented_execute_through == "tag14_preparation"
...
readonly post_tag13_fail='fail "publication phase is not implemented; Tag14 preparation completed; do not retry this run"'
