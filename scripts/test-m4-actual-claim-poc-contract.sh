...
jq -e '
  ...
  and .implemented_execute_through == "monero_sweep"
...
readonly post_tag13_fail='fail "binding phase is not implemented; Monero sweep completed; do not retry this run"'
