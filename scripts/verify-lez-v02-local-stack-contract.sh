...
runtime_base="cgr.dev/chainguard/glibc-dynamic:latest@sha256:205572d5e48117e14b44b42627890fa8d3e8e65bb37a80abb3317e5151e7f35b"
r0vm_sha256="05a4dc3224736c966e1c122e9c896e54443d68ed562396428bc0693f3341c098"
...
rg -Fqx 'contract_status = "private_local_two_direction_claim_happy_path_green_hardening_pending"' "$contract"
...
rg -Fqx 'runtime_smoke_status = "minimal_runtime_base_digest_pinned_ci_service_smoke_required"' "$contract"
...
rg -Fqx 'full_runtime_tuple_scope = "private_local_two_direction_claim_happy_path"' "$contract"
rg -Fqx 'last_service_readiness_run_id = "v02-actors-finalized-20260713b"' "$contract"
rg -Fqx 'full_runtime_tuple_green = true' "$contract"
rg -Fqx 'corridor_run_ids = ["m2poc-corridor-fresh-20260714o", "m2poc-corridor-reverse-fresh-20260714c"]' "$contract"
rg -Fqx 'corridor_directions = ["taker_sells_lez", "taker_sells_foreign"]' "$contract"
rg -Fqx 'corridor_evidence_files = ["docs/evidence/m2-taker-sells-lez-corridor-20260714.json", "docs/evidence/m2-taker-sells-foreign-corridor-20260714.json"]' "$contract"
rg -Fqx 'corridor_actor_config_schema_version = 2' "$contract"
rg -Fqx 'current_actor_config_schema_version = 3' "$contract"
rg -Fqx 'current_schema_corridor_run_ids = ["m2cert-schema3-forward-2d09997-20260714a", "m2cert-schema3-reverse-2d09997-20260714a"]' "$contract"
rg -Fqx 'current_schema_corridor_evidence_file = "docs/evidence/m2-schema-v3-local-corridors-20260714.json"' "$contract"
rg -Fqx 'current_schema_actual_node_smoke = true' "$contract"
rg -Fqx 'completed = ["vault_claims", "checked_escrow_deployment", "maker_actor", "taker_actor", "two_direction_claim_swap_effects", "current_schema_v3_two_direction_actual_node_smoke"]' "$contract"
rg -Fqx 'clean_host_reproductions = 0' "$contract"
rg -Fqx 'fresh_onboarding_and_deployment_automation = false' "$contract"
rg -Fqx 'pending = ["clean_host_reproduction", "fresh_vault_onboarding_automation", "fresh_checked_escrow_deployment_automation", "composed_restart_recovery", "composed_refund", "composed_reorg", "composed_concurrency"]' "$contract"
