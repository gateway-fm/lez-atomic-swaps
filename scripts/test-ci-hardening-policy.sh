...
ripgrep_installer="${repo_root}/scripts/install-ci-ripgrep.sh"
...
[[ -x "$ripgrep_installer" ]] || fail "missing executable checksum-pinned ripgrep installer"
...
require_fixed './scripts/test-m7-r1-taker-first-actual-baseline.sh' "$quality_runner"
require_fixed './scripts/test-m7-r2-on-chain-only-actual-baseline.sh' "$quality_runner"
...
require_fixed './scripts/install-ci-ripgrep.sh' "$workflow"
require_fixed 'ripgrep-14.1.1-x86_64-unknown-linux-musl.tar.gz' "$ripgrep_installer"
require_fixed '4cf9f2741e6c465ffdb7c26f38056a59e2a2544b51f7cc128ef28337eeae4d8e' \
  "$ripgrep_installer"
