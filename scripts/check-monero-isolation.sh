...
required_runner_terms=(
  ...
  'MONERO_FUNDING_RPC_USERNAME_FILE'
  'MONERO_FUNDING_RPC_PASSWORD_FILE'
  'MONERO_MAKER_RPC_USERNAME_FILE'
  'MONERO_MAKER_RPC_PASSWORD_FILE'
  'MONERO_TAKER_RPC_USERNAME_FILE'
  'MONERO_TAKER_RPC_PASSWORD_FILE'
  'MONERO_TAKER_WALLET_PASSWORD_FILE'
