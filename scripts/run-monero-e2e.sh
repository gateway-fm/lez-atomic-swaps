...
write_secret_value "${credentials_dir}/funding.rpc.username" funding
write_secret_value "${credentials_dir}/funding.rpc.password" "$funding_rpc_secret"
write_secret_value "${credentials_dir}/maker.rpc.username" maker
write_secret_value "${credentials_dir}/maker.rpc.password" "$maker_rpc_secret"
write_secret_value "${credentials_dir}/taker.rpc.username" taker
write_secret_value "${credentials_dir}/taker.rpc.password" "$taker_rpc_secret"
write_secret_value "${credentials_dir}/funding.wallet.password" "$funding_wallet_password"
write_secret_value "${credentials_dir}/maker.wallet.password" "$maker_wallet_password"
write_secret_value "${credentials_dir}/taker.wallet.password" "$taker_wallet_password"
...

{
  ...
  printf 'export MONERO_FUNDING_RPC_USERNAME_FILE=%q\n' "${credentials_dir}/funding.rpc.username"
  printf 'export MONERO_FUNDING_RPC_PASSWORD_FILE=%q\n' "${credentials_dir}/funding.rpc.password"
  printf 'export MONERO_FUNDING_WALLET_PASSWORD_FILE=%q\n' "${credentials_dir}/funding.wallet.password"
  printf 'export MONERO_MAKER_CREDENTIAL_FILE=%q\n' "${credentials_dir}/maker.curlrc"
  printf 'export MONERO_MAKER_RPC_USERNAME_FILE=%q\n' "${credentials_dir}/maker.rpc.username"
  printf 'export MONERO_MAKER_RPC_PASSWORD_FILE=%q\n' "${credentials_dir}/maker.rpc.password"
  printf 'export MONERO_MAKER_WALLET_PASSWORD_FILE=%q\n' "${credentials_dir}/maker.wallet.password"
  printf 'export MONERO_TAKER_CREDENTIAL_FILE=%q\n' "${credentials_dir}/taker.curlrc"
  printf 'export MONERO_TAKER_RPC_USERNAME_FILE=%q\n' "${credentials_dir}/taker.rpc.username"
  printf 'export MONERO_TAKER_RPC_PASSWORD_FILE=%q\n' "${credentials_dir}/taker.rpc.password"
  printf 'export MONERO_TAKER_WALLET_PASSWORD_FILE=%q\n' "${credentials_dir}/taker.wallet.password"
} >"$manifest"
chmod 0600 "$manifest"
