#!/usr/bin/env bash
# Runs every non-destructive check over the running stack:
#   1. container health
...
#
# It starts no swaps and mutates nothing that survives the run.
set -uo pipefail
...
python3 scripts/verify-explorers.py
