...
| Official deliverable | Submission artifact | Status |
|---|---|---|
| LEZ escrow update for Schnorr/Taproot adaptor-witness settlement | [ADRs 0042–0045](../docs/architecture/0042-bind-witnessed-token-claims-to-exact-atas.md), [both-direction evidence](../docs/evidence/m3-local-two-direction-poc-20260715.json), matching [UI evidence](../docs/evidence/m3-btc-ui-run-m5arm-0820121736.json) | Functional evidence and architecture included; the historical Rust workspace is not copied wholesale into this snapshot |
