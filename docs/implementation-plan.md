...
- [ ] Complete typed LEZ and Zcash actions plus atomic active-swap transition
  ...
  matrix, reverse
  fresh eligibility, second-lock effect that consumes eligibility in the same
