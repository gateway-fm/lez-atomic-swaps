...
- [ ] Complete typed LEZ and Zcash actions plus atomic active-swap transition
  ...
  classes. Native-refund sidecar/context wiring and main claim SDK-port
...
- [ ] Complete peer-independent timeout recovery through public SDK ports. The
  ...
  official refund sidecar, caller-context SDK-port wiring, and composed
  independent actors remain before this gate can close.
