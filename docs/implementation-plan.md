...
- [ ] Complete typed LEZ and Zcash actions plus atomic active-swap transition
  ...
  Crash-safe caller-context SDK ports, actor processes, and the composed
  corridor remain.
  ...
  observation. Crash-safe context-owning SDK-port composition remains. Pin
