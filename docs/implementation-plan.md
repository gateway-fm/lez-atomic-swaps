...
| Generated transition sequences | 2026-07-11 property oracles exposed both confirmation growth and regression cases and were corrected | 512 arbitrary event sequences plus retained minimized reorg seed preserve legal transitions and absorbing terminal states | Add explicit replacement events and typed per-chain deadlines |
...
| Taker-lock confirmation regression | 2026-07-11 missing durable reorg phase; property oracle assumed confirmations only rise | Pre-maker regression revokes lock permission; post-maker regression suspends claims, can reconfirm, and preserves both refunds; minimized property seed retained | Add explicit transaction removal/replacement and pair-specific reorg depth policies |
