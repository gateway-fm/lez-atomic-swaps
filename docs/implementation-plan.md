...
- [ ] Complete typed LEZ and Zcash actions plus atomic active-swap transition
  ...
  adapter, official-wire transaction decoding, LEZ exact-head
  depth/removal/replacement tracker, token-custody observation matrix, reverse
