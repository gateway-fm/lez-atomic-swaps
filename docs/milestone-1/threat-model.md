...
| Rollback/reorg after observation | Coordinator acts on non-canonical evidence | Confirmation regression before maker lock revokes permission; after maker lock durably suspends claims while refunds remain; pair-specific finality policy and chain tests remain |
