...
| Rollback/reorg after observation | Coordinator acts on non-canonical evidence | Pair-specific confirmation/finality policy and continuous canonicality checks |
