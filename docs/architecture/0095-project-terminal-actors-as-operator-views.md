...
- Status: Accepted for implementation; exact actual-node replay pending
- Date: 2026-07-24
...
- Focused schema/restart/idempotency and compile gates are GREEN. The exact M5
  local-devnet rerun, retained evidence refresh, and milestone tag remain gated.
