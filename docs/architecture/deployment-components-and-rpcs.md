...
| Chat | Planned | No protocol, endpoint, or port selected | Mutually authenticated exact-amount negotiation and countersigned pair transcript | `NegotiationChannel` | Untrusted/removable after first lock |
