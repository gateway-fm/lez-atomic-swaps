...
| [0029](0029-m3-bitcoin-local-poc-entry.md) | Enter M3 through isolated Bitcoin Core Regtest and LEZ v0.2 actors with aggregate witnessed claim authorities | Accepted and in closure: schema-4 happy/refund/survivor/overlap and F7 are actual-node GREEN; public lifecycle SDK, official/independent vectors, Testnet4 configuration, three source recordings/private bundle, and ADR 0050 security map are complete. ADR 0052 closes the literal video mismatch; live MP4s and final gates remain before the milestone tag |
...
| [0052](0052-bind-private-demo-videos-to-actual-node-evidence.md) | Regenerate a canonical proof from retained role/effect evidence before rendering and final verification of each private D1 MP4 | Accepted for the M3 evidence pipeline. Source and contract gates are GREEN; three live private MP4s, sampled-frame review, and the final bundle remain |
