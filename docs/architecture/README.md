...
| [0013](0013-sdk-layering.md) | Deterministic common core plus complete per-pair async facades | Concrete ZEC negotiation, both lock effects, and schema-v8 replay proven; later effects and chain adapters pending |
...
| [0017](0017-crash-safe-first-lock-intent.md) | Exact role-fixed lock bytes are durable and observed before byte-identical submission | Taker and maker intents plus canonical history survive schema-v8 restart; maker funding reaches `BothLegsLocked`; production canonical adapters and claim effects pending |
...
| [0020](0020-durable-maker-second-lock.md) | Fresh eligibility is consumed by a separately durable opposite-chain maker effect | Separate maker/taker stores in both directions replay from schema v8 at `BothLegsLocked`; canonical production adapters and claims pending |
