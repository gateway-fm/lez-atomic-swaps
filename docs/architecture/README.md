...
| [0174](0174-join-tag17-to-the-funded-monero-output.md) | Fund and re-observe the exact Stage-A Monero output around the terminal Tag17 LEZ punishment in one isolated run | Opt-in runner and evidence contract GREEN; exact pushed-commit two-devnet replay and losing-branch/adverse hardening remain pending |
