...
| [0114](0114-compose-xmr-application-before-chain-effects.md) | Bind one Delivery-derived XMR swap through application activation and a zero-effect supervisor cutoff before the existing actual-chain claim path owns liveness | Proposed and in progress; actual isolated execution, process-absence cutoff, cross-chain evidence, and cleanup verification remain pending |
