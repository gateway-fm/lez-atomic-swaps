...
| [0103](0103-persist-replay-safe-manual-actor-actions.md) | Bind explicit claim/refund requests to the global mutation ledger and the existing owner/generation/kernel-lock execution authority | Accepted foundation; schema-v17 replay, conflict, fencing, atomic resolution, reopen, and abandoned-transfer tests GREEN. Actor progress and Maker/Taker command routing remain |
