...
| [0195](0195-recover-taker-monero-claim-sweep-after-process-kill.md) | Split the Taker Monero claim sweep into one sealed send and read-only restart observation | Proposed; RED contract established, implementation and exact-node certificate pending |
