...
| [0022](0022-isolate-lez-official-wire-sidecar.md) | Keep incompatible pinned LEZ official-wire and Zcash graphs in separate processes behind a bounded local protocol | Accepted for the M2 actual-node corridor; executable sidecars plus native escrow and revealing-claim observation GREEN, native refund/main claim adapters and composed evidence in progress |
