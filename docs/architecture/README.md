...
| [0091](0091-complete-chat-with-daemon-owned-authority.md) | Keep claim authority daemon-local and reuse the existing atomic transaction for exact dual-signed Chat completion | Accepted and process component GREEN; taker CLI, final actor configs, and corridor composition remain |
