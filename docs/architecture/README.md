...
| [0145](0145-serialize-refund-observation-and-layer-timeouts.md) | Serialize post-finality Refund observation and nest measured local timeout layers without removing pinned state checks | Zero-call quiescence, exact predicate edges, 60/75/90-second timeout hierarchy, and local actor-config regressions GREEN; fresh actual-node Refund certificate pending |
