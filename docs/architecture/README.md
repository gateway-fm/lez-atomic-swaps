...
| [0029](0029-m3-bitcoin-local-poc-entry.md) | Enter M3 through isolated Bitcoin Core Regtest and LEZ v0.2 actors with aggregate witnessed claim authorities | Accepted and active; Core 31.1 role infrastructure plus the typed P2TR/CSV transaction slice are GREEN. Actual Core spend, adaptor protocol, LEZ BTC guest, and both actor directions remain |
