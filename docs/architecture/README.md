...
| [0194](0194-recover-taker-tag14-after-process-kill.md) | Kill the Taker CLI after one accepted Tag14 invocation, then recover through observation without another send | Feature-gated QA seam and focused gates GREEN; exact pushed-source local-devnet replay pending |
