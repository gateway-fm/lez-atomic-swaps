...
| [0176](0176-exclude-losing-tag17-after-finalized-tag16.md) | Prepare valid Tag17 before Tag16, then prove one late Tag17 cannot replace finalized Tag16 | Accepted; focused RED/GREEN classifier and isolated runner contracts are GREEN, exact pushed-commit replay pending |
