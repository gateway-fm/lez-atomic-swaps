...
| [0177](0177-reconcile-killed-monero-refund-actors.md) | Pause only after one Monero refund send, then require a killed actor to resume through observation rather than resend | Accepted; feature-gated real-actor component and joined runner contracts GREEN, while exact actual-node replay remains pending |
