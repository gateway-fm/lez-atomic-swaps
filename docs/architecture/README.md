...
| [0193](0193-recover-accepted-zec-after-process-kill.md) | Kill the accepted ZEC Maker daemon and actor after one funding submission, then recover the same unmined transaction through observation | Accepted; local-devnet PoC and CI contract GREEN, pushed-source certificate pending |
