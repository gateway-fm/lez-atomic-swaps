...
| [0175](0175-reject-losing-tag16-after-finalized-tag17.md) | Complete valid Tag16 before Tag17, then prove one late Tag16 cannot replace finalized Tag17 | Opt-in runner and TDD contract GREEN; admitted-versus-finalized semantics corrected, final exact pushed-commit replay pending |
