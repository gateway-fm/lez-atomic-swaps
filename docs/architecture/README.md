...
| [0140](0140-prefer-durable-terminal-conflicts.md) | Resolve exact replay and any durable terminal winner before consulting transient actor availability | Process/no-mutation and atomic-race mapping regressions are GREEN; a fresh actual-node Refund certificate remains pending |
