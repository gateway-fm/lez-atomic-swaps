...
| [0022](0022-isolate-lez-official-wire-sidecar.md) | Keep incompatible pinned LEZ official-wire and Zcash graphs in separate processes behind a bounded local protocol | Accepted for the M2 actual-node corridor; sidecars plus native escrow/claim observation and main refund validation GREEN, refund-sidecar/main-claim composition and actor evidence in progress |
