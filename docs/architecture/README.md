...
| [0126](0126-separate-xmr-effect-workflow-authority.md) | Separate role-local XMR branch and process orchestration from immutable adaptor transcripts and tag-specific one-attempt sidecar journals | Accepted for the durable journal component; schema-v3 authority, receipt-v2 commands, and actual-node lifecycle replay remain in progress, so literal M5 stays `4/7` |
