...
| [0023](0023-private-local-m2-certification.md) | Certify M2 through a private fully functional actual-node corridor and defer public deployment/testnet publication | Accepted; both private local happy directions and the locally tested dormant public-portability contracts are GREEN. Public transactions/recordings remain deferred, and official LEZ finalized-tip method availability is an upstream production risk |
...
| [0028](0028-dormant-public-route-portability.md) | Admit exact dormant public LEZ and Zebra routes without exposing the actor-sidecar boundary or weakening agreement-bound pre-effect validation | Configuration and bounded-client construction GREEN without public I/O; live public execution and official LEZ finalized-tip method availability remain production gates |
