...
| [0141](0141-certify-terminal-refund-replay.md) | Bind canonical Zcash inclusion and post-terminal exact Refund replay to unchanged LEZ and Zebra effects | Focused RED to GREEN runner contract complete; fresh actual-node certificate pending |
