...
| [0009](0009-bitcoin-refund-path.md) | Taproot key-path cooperative claim with script-path CSV refund | Accepted; known-key Core funding/claim is GREEN, while MuSig2/adaptor and refund evidence remain |
...
| [0029](0029-m3-bitcoin-local-poc-entry.md) | Enter M3 through isolated Bitcoin Core Regtest and LEZ v0.2 actors with aggregate witnessed claim authorities | Accepted and active; a known-key funding/claim pair is policy-accepted and mined by Core 31.1. MuSig2/adaptor, independent actors/stores, LEZ BTC guest, and both complete directions remain |
