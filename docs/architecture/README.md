...
| [0141](0141-certify-terminal-refund-replay.md) | Bind canonical Zcash inclusion and post-terminal exact Refund replay to unchanged LEZ and Zebra effects | Evidence wiring and measured 190-second outer ceiling are contract-GREEN; fresh actual-node certificate pending |
