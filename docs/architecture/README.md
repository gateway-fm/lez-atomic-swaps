...
| [0146](0146-pin-basecamp-builds-behind-consumer-locks.md) | Pin Basecamp QML, LGX, and loader builds behind repository-owned consumer locks and a digest-pinned Nix image | Official tutorial default package and LGX rehearsal GREEN; upstream all-output integration evaluation and production closure review remain disclosed, while Maker/Taker source still waits for owner prototype sign-off |
