...
| [0182](0182-preserve-asset-aware-refund-effect-counts.md) | Preserve the native/custom-token durable-effect invariant after finalized refund projection | Accepted; RED/GREEN orchestration contract passes, while the fresh actual-node replay remains pending |
