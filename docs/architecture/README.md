...
| [0019](0019-canonical-lez-observation.md) | Stable agreement-bound LEZ fund transaction, block, metadata, and custody evidence is replayed from primitive snapshots | Canonical/update exact-head folding accepted in SDK/SQLite; official-wire adapter and durable removal/replacement records pending |
