...
| [0130](0130-expose-a-strict-role-fixed-taker-facade.md) | Expose only seven typed role-fixed Taker methods and keep private receipts, keys, paths, and effect authority behind the service | Contract and real authenticated read backend GREEN through `1584b76`; mutation registry, private resolution, QML host wiring, and actor-real E2E remain |
| [0131](0131-isolate-taker-facade-on-owner-service.md) | Run the Taker facade as a separate owner-only Unix service and register only methods with real backing logic | Reusable socket custody and read backend GREEN; RPC module, process binary, durable mutation registry, and UI host remain |
