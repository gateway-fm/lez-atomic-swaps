...
| [0081](0081-pluggable-maker-price-source.md) | Read exact maker prices through a pluggable boundary; isolate the provisional Logos C ABI in a one-shot worker | Accepted; local adapter and actual-C worker boundary GREEN, parent controls and signed-offer binding remain |
