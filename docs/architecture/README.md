...
| [0012](0012-lez-escrow-custody.md) | Split metadata PDA from native vault or required custom-token ATA | Custom-token semantics validated; native-user/ATA/sequencer pending |
