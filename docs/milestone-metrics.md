...
| M6 | Certification-gate progressive local-functional PoC | The signed-off Maker/Taker prototypes and networkless actor browser are GREEN 6/6. Both consumer-locked Basecamp `ui_qml` packages now build module, LGX, installer, and official integration outputs; load in pinned Basecamp 0.2.0-RC3; fail closed without their owner service; and exercise real role services through typed process-isolated backends. Maker health, atomic route save, and history are product-GREEN. Taker health, offer browse, prepared initiation, exact UI replay, list, monitor, and the post-product registry assertion are product-GREEN. Fresh actual-node service certificates remain deliberately layered: `m6claim0ba41aba` finalized one LEZ Claim and one canonical Zcash Claim with no-effect replay in 33.330 seconds; `m6refund8f76d87a` finalized one LEZ Refund then one canonical Zcash Refund, excluded the opposite Claim, and replayed without effect in 211.530 seconds. No public RPC, faucet, public funds, or public deployment participated. Documentation/evidence updates are active; final repository gates, exact M6 resource cleanup, certification commit/push, and tag remain. Cross-restart rollback anchoring plus LOGOS-024/025 release findings remain production hardening, not issue-#112 PoC blockers | None until final gates prove the tag candidate | Owner directed M6 entry and approved prototypes; package/product evidence is GREEN and M6 tagging awaits only certification closure |
