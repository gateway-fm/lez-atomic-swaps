...
| M6 | Active progressive local-functional PoC | Clickable Maker/Taker prototypes, explicit 2026-08-04 owner signoff, and isolated actor browser are GREEN 6/6. The Maker atomic route, strict Taker service, prepared acceptance, receipt-bound reads, and terminal authorization are component-GREEN. Fresh pushed-commit regression `m6claim0ba41aba` proves the service-driven local `TakerSellsLez` Claim on wholly fresh LEZ and Zebra stacks after the shared timeout change: first admission returned replay false, the empty Zebra mempool gained exactly transaction `0da6b4c2...d2abf`, exact durable replay returned replay true with the identical one-transaction mempool, LEZ Claim `f865903e...14d0cc` finalized exactly once at block 127, the Zcash Claim became canonical at height 107, and both actors completed in 33.330 seconds with zero drive retries. Deterministic local funds only; no public RPC, faucet, public funds, or public deployment participated. Fresh pushed-commit run `m6refund8f76d87a` additionally certifies service-driven Refund on wholly fresh LEZ and Zebra stacks: LEZ refund `c43df1bb...dcf5ad` finalized exactly once at block 129 before Maker Zcash refund `db066a94...5ab470` appeared exactly once in canonical block 110; Maker, Taker, and service reached `refunded`; opposite Claim conflicted; terminal replay added no effect; completion took 211.530 seconds with no public RPC, faucet, public funds, or public deployment. Locked tutorial package, core/UI LGXs, exact `lgpm` install, and the pinned official Basecamp 0.2.0-RC3 binary/runtime smoke are GREEN. Maker/Taker Basecamp `ui_qml`, QtRO hosts, product-package load, actor-real UI E2E, final gates, and tag remain. Cross-restart rollback anchoring is deferred production hardening, not an issue-#112 PoC gate | None | Owner directed M6 entry on 2026-08-03 and approved the prototypes on 2026-08-04; full M6 remains incomplete |
