...
and restore-only startup revalidation. The current full pinned sidecar gate is
141 of 141 with strict Clippy and Rustdoc. Actual deployment, actual-local
tag-13 execution, tag-14/tag-15 finality and tag-15 submission, adaptor
