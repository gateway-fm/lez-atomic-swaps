...
| F4 | LEZ–transparent-ZEC via BIP-199 HTLC; LEZ claim/refund precedes ZEC and the ZEC refund strictly outlives LEZ by the documented margin | Direction-aware LEZ-recipient/preimage tests and exact 92-byte BIP-199 redeem vector pass; claim/refund stack, P2SH, Zebra consensus, and both-direction testnet happy/refund/concurrency role E2E remain | Core ordering and redeem script implemented; chain lifecycle M2 |
