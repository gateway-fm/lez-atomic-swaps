...
| U6 | Basecamp taker mini-app browses and executes swaps | Signed-off prototype first, then actor-real UI E2E through a role-fixed Taker lifecycle facade for each pair including refund and ZEC shield-after-swap guidance | M6 active under ADR 0128 |
...
| S11 | Figma designs or equivalent for both mini-apps | Signed-off clickable HTML prototypes cover Maker and Taker role journeys before production QML is accepted | M6 active under ADR 0128 |
