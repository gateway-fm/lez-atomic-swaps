...
This meets the two-direction PoC gate only. M2 remains untagged while
repository completion and dormant public-portability gates remain; actual-node
refund/restart/reorg/chaos and live public execution retain their explicitly
deferred status.
