...
| F4 | LEZ–transparent-ZEC via BIP-199 HTLC; LEZ claim/refund precedes ZEC and the ZEC refund strictly outlives LEZ by the documented margin | Direction-aware LEZ-recipient/preimage, exact redeem/P2SH/scriptSig vectors, and upstream wrong-preimage/CLTV interpreter boundaries pass; Zebra transaction consensus and both-direction testnet happy/refund/concurrency role E2E remain | Core ordering and contract envelope implemented; transaction/chain lifecycle M2 |
