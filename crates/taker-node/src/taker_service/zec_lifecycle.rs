//! Prepared-ZEC Taker lifecycle: initiation, monitoring, and generation-fenced
//! claim/refund over the ZEC reference actor. Compiled only with `pair-zec`.
...
use crate::{
    ConfiguredTakerInitiationContext, PreparedZecTakerInitiationV1, TakerActionCommitV1,
